...
<html lang="en">
  <head>
    ...
    <title>รายงานการตรวจเช็คส่งใบเกียรติบัตร - เกียรติบัตรการประชุมการวิจัยทางการศึกษาระดับชาติ ครั้งที่ 16  </title>
    <!-- CSS files -->
    ...
    <div class="wrapper">
      <header class="navbar navbar-expand-md navbar-light d-print-none">
        <div class="container-xl">
          ...
          <a href=".">
            เกียรติบัตรการประชุมการวิจัยทางการศึกษาระดับชาติ ครั้งที่ 16  
            </a>
          </h1>
          ...
          <div class="navbar navbar-light">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="26082564.php" >
                ...
                <li class="nav-item">
                  <a class="nav-link" href="27082564.php" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/file-text -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><line x1="9" y1="9" x2="10" y2="9" /><line x1="9" y1="13" x2="15" y2="13" /><line x1="9" y1="17" x2="15" y2="17" /></svg>
                    </span>
                    <span class="nav-link-title">
            ...
            <div class="row row-deck row-cards">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="h1 mb-3" id="26total">00</div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="h1 mb-3"><h2 id="total260864">00</h2></div>
                    <div class="d-flex mb-2">
                      <div>ความคืบหน้าการส่ง</div>
                      <div class="ms-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                    ...
                    <div class="progress progress-sm">
                      <div class="progress-bar bg-blue" style="width: 75%" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                        <span class="visually-hidden" id="Percent260864">00%</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="h1 mb-3"><h2 id="total270864">00</h2></div>
                    <div class="d-flex mb-2">
                      <div>ความคืบหน้าการส่ง</div>
                      <div class="ms-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                    ...
                    <div class="progress progress-sm">
                      <div class="progress-bar bg-blue" style="width: 75%" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                        <span class="visually-hidden" id="Percent270864">00%</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">ส่งซ้ำ</div>
                      <div class="ms-auto lh-1">
                      <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">26/08/2564</a>
                      </div>
                    </div>
                    <div class="h1 mb-3"><h2 id="resend270864">00</h2></div>
                    <div class="d-flex mb-2">
                      <div>ความคืบหน้าการส่ง</div>
                      <div class="ms-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
              ...
              <div class="col-lg-6">
                <div class="row row-cards">
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <p class="mb-3">วันที่ 26 สิงหาคม 2564 <strong> 00000 คน </strong></p>
                  ...
                  <div class="col-sm-4">
                    <div class="card">
                      <div class="card-body p-2 text-center">
                        ...
                        <div class="h1 m-0"><span id="output">00</span></div>
                        <div class="text-muted mb-3">จำนวนใบประกาศ 27082564</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
              ...
              <div class="col-lg-6">
                <div class="card">
                  ...
                  <div class="card-table table-responsive" id="tableshow">
                  *แสดงข้อมูลการส่งผิด*
                  </div>
                </div>
              </div>
